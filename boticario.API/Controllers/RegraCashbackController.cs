...
namespace boticario.API.Controllers
{
    ...
    public class RegraCashbackController : ControllerBase, IController<RegraCashback>
    {
        ...
        private readonly ILogger<RegraCashbackController> logger;

        private readonly string controllerName = nameof(RegraCashbackController);

        public RegraCashbackController(RegraCashbackService service, ILogger<RegraCashbackController> logger)
        {
        ...
        public async Task<ActionResult<IEnumerable<RegraCashback>>> GetAll()
        {
            ...
            try
            {
                ...
                IEnumerable<RegraCashback> entities = await service.GetAll(UserTokenOptions.GetClaimTypesNameValue(User.Identity));
        ...
        public async Task<ActionResult<RegraCashback>> GetById(int id)
        {
            ...
            try
            {
                ...
                RegraCashback entity = await service.GetById(id, UserTokenOptions.GetClaimTypesNameValue(User.Identity));
